...
export default function (req, res) {
  try {
    ...
    const mailData = {
      ...
      to: "uwworkflow@gmail.com",
      bcc: `${review.emails}`,
      subject: `Notifications from UW Workflow`,
      text: `Hi, You are recieving this notification because you have bookmarks on UWWorkflow`,
      ...
      * {
      ...
      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">New Review Added!</span></strong></span></p>
        </div>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="padding-right: 0px;padding-left: 0px;" align="center">
            ...
            <img align="center" border="0" src="https://i.imgur.com/2ESFEPI.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 580px;" width="580"/>
      ...
      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: #272362; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 24px; line-height: 33.6px;">Thanks for being a part of the UWWorkflow community</span><span style="font-size: 24px; line-height: 33.6px;">.</span></p>
        </div>
      ...
      <p style="font-size: 14px; line-height: 140%;">To unsubscribe from the email, go to uwworkflow.com and remove the bookmark<br />EMAIL: uwworkflow@gmail.com </p>
        </div>
      ...
      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: #bbbbbb; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">&copy;UWWorkflow&nbsp; |&nbsp; All Rights Reserved </span></p>
        </div>
