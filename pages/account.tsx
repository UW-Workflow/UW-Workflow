  ...
  return (
    <MainContainer>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col rounded-lg bg-white mb-5 shadow">
          <div className="flex flex-grow m-5">
            <div className="rounded-lg shadow flex-grow">
              <div className="flex flex-row">
                ...
                <div className="px-10 bg-light-button-blue flex flex-row rounded-lg ml-auto mr-2 my-5">
